...
edited: 1/15
developers:
myg	discord: Olixy ⚜#4595
flipx_x discord: flipx_x#8189
...
function Library:create(options)
	...
	if readfile and writefile and isfile then
		if not isfile("SimpleHacksSettings.json") then
			writefile("SimpleHacksSettings.json", HTTPService:JSONEncode(settings))
		end
		settings = HTTPService:JSONDecode(readfile("SimpleHacksSettings.json"))
	...
	creditsTab:credit{Name = "flipx_x", Description = "Library Developer", Discord = "flipx_x#8189"}
	creditsTab:credit{Name = "myg", Description = "Library Developer", Discord = "Olixy ⚜#4595"}
	creditsTab:credit{Name = "Discord server", Description = "Discord server", Discord = "https://discord.gg/2psXXRh7Qc"}
